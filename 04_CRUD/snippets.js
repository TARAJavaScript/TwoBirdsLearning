...
tb.namespace('app.Test').set(
    ...
    (function () {
        ...
        var InputField = (function () {
            ...
            function InputField(pConfig, pTarget) {
                var that = this;
            ...
            InputField.prototype = {
                inputTemplate: '<div><form><input type="text" placeholder="Id"></input></form></div>',
                render: render
            };
            ...
            function render() {
                ...
                var that = this,
                    inputField = $(tb.parse(that.inputTemplate, that.data));

                $(that.target).append(inputField);
